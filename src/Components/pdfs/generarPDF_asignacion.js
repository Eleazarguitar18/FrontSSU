...
export const generarPDF_asignacion = (row) => {
  const doc = new jsPDF();
  ...
  const topHeaders = [
    ...
    ["FORMULARIO DE ASIGNACION " + anio.toString()],
  ];
  ...
  const datosEquipo = [
    ...
    ["MARCA:", row.Dispositivo.Marca],
    ["DETALLE:", row.Dispositivo.Detalle],
    ["NOMBRE DEL EQUIPO:", row.Dispositivo.NombreDelEquipo],
    // ... Agrega más datos según sea necesario
  ];
